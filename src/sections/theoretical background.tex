...
\\Summarizing, we have:\\
$\psi(\vec{r},t)=\left( \frac{1}{2\pi} \right) \iint\limits_{-\infty}^{\quad \infty}\mathcal{FT}_{2D}\left[ T(x,y)U_o(x,y,0^-) \right]e^{i \left( \vec{k}\cdot\vec{r}-\omega_0 t \right)}dk_x dk_y$\\
